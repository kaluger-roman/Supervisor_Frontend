...
export const AppIntro: React.FC = () => (
  <div className="AppIntro">
    ...
    <div className="criterion">
      <div className="text text0">С</div>
      <div className="text text1">Т</div>
      <div className="text text2">А</div>
      <div className="text text3">Р</div>
      <div className="text text4 needTranslate">Ы</div>
      <div className="text text5">Й</div>
